...
public class CFInnerFetch extends BasicCleanseFunctionAbstract {
    ...
    public CFInnerFetch() {
        ...
        this.metaModelService = CFAppContext.getBean(MetaModelService.class);
    }
    ...
    @Nonnull
    SearchRequestContext createSearchRequest(Map<String, Object> input) throws CleanseFunctionExecutionException {
    ...
    private SimpleAttribute<?> createSearchAttr(Map<String, Object> input) throws CleanseFunctionExecutionException {
        String entityName = (String) super.getValueByPort(ENTITY_NAME_PORT, input);
    ...
    @Nullable
    Attribute retrieveAttr(SearchResultDTO search, Map<String, Object> input) throws CleanseFunctionExecutionException {
        String entityName = (String) super.getValueByPort(ENTITY_NAME_PORT, input);
        String returnFieldName = (String) super.getValueByPort(RETURN_NAME_PORT, input);
