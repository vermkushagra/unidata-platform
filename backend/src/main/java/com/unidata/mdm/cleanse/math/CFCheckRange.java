 ...
 * @author ilya.bykov
 */
public class CFCheckRange  extends BasicCleanseFunctionAbstract implements CFSystemCleanseFunction {
    ...
    public void execute(CleanseFunctionContext ctx) {
        ...
        if (param1 == null || param1.isEmpty()) {
            ...
            Long minValue = param2 == null ? null : param2.toSingletonValue();
            Long maxValue = param3 == null ? null : param3.toSingletonValue();

            minValue = minValue == null ? Long.MIN_VALUE : minValue;
            maxValue = maxValue == null ? Long.MAX_VALUE : maxValue;
            ...
            for (int i = 0; i < param1.getAttributes().size(); i++) {
                ...
                List<Long> valuesToCheck = attribute.isSingleValue()
                        ? Collections.singletonList(((SingleValueAttribute<Long>) attribute).getValue())
                        : ((ArrayAttribute<Long>) attribute).toList();

                for (Long valueToCheck : valuesToCheck) {
