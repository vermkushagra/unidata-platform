 ...
 * @author ilya.bykov
 */
public class CFRound extends BasicCleanseFunctionAbstract implements CFSystemCleanseFunction {
    ...
    public void execute(CleanseFunctionContext ctx) {
        ...
        if (param1 == null || param1.isEmpty() || param2 == null || param2.isEmpty()) {
            ...
            Long value2 = param2.toSingletonValue();
            Double result = new BigDecimal(String.valueOf(value1.doubleValue()))
                    .setScale(value2.intValue(), BigDecimal.ROUND_HALF_UP).doubleValue();

            ctx.putOutputParam(CleanseFunctionOutputParam.of(OUTPUT1, result));
        }
    }
    /**
     * {@inheritDoc}
