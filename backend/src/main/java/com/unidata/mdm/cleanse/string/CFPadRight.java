 ...
 * @author ilya.bykov
 */
public class CFPadRight extends BasicCleanseFunctionAbstract implements CFSystemCleanseFunction {
    ...
    public void execute(CleanseFunctionContext ctx) {
        ...
        Long padRight = param2.toSingletonValue();
        ctx.putOutputParam(CleanseFunctionOutputParam.of(CleanseConstants.OUTPUT1, StringUtils.rightPad(param1.toSingletonValue(), padRight.intValue())));
    }
    /**
     * {@inheritDoc}
     */
