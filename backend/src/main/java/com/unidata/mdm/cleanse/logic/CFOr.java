...
/**
 * Cleanse function performs OR operation.
 */
public class CFOr extends BasicCleanseFunctionAbstract {

    /**
     * Instantiates a new CF or.
     **/
    public CFOr() {
        super(CFOr.class);
    }
    ...
    public void execute(Map<String, Object> input, Map<String, Object> result) throws CleanseFunctionExecutionException {
        ...
        Boolean resultBoolean = BooleanUtils.or((Boolean[]) Arrays.asList(input1, input2).toArray());
