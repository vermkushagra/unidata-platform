...
/**
 * Cleanse function performs subtraction operation.
 * @author ilya.bykov
 */
public class CFSubstract extends BasicCleanseFunctionAbstract implements CFSystemCleanseFunction {

    /**
     * Instantiates a new CF substract.
     *
     */
    public CFSubstract(){
        super(CFSubstract.class);
    }
    /**
     * {@inheritDoc}
     */
