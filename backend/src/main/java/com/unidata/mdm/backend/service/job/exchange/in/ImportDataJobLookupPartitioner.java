 ...
 */
@JobScope
public class ImportDataJobLookupPartitioner extends ImportDataJobAbstractPartitioner implements Partitioner {
    /**
    ...
    public Map<String, ExecutionContext> partition(int gridSize) {
        ...
        List<ExchangeEntity> lookups = new ArrayList<>(def.getLookupEntities());
        Collections.sort(lookups, ImportDataJobConstants.ENTITY_IMPORT_ORDER_COMPARATOR);
        ...
        for (ExchangeEntity entity : lookups) {
