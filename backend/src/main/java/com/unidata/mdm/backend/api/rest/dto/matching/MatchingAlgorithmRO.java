...
public class MatchingAlgorithmRO {
    ...
    private boolean preprocessingAvailable;
    ...
    public boolean isPreprocessingAvailable() {
        return preprocessingAvailable;
    }

    public void setPreprocessingAvailable(boolean preprocessingAvailable) {
        this.preprocessingAvailable = preprocessingAvailable;
    }
}
