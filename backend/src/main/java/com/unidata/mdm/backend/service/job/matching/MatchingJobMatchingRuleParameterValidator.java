 ...
 */
public class MatchingJobMatchingRuleParameterValidator implements JobParameterValidator {

    private final static String INCORRECT_PREPROCESSING = "app.job.matching.parameters.matchingRule.incorrectPreprocessing";

    private final static String INCORRECT_MATCHING_RULE = "app.job.matching.parameters.matchingRule.incorrect";

    private final static String INCORRECT_ENTITY_NAME = "app.job.matching.parameters.entityName.incorrect";
