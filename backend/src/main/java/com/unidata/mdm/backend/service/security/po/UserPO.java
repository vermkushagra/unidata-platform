...
public class UserPO extends BaseUserPO implements Serializable {
     ...
     * Property values.
     */
    private transient List<UserPropertyValuePO> properties;
	/**
	...
	public static final class Fields extends BaseUserPO.Fields  {
		...
		public static final String ALL = String.join(DELIMETER,   CREATED_AT,  CREATED_BY,
				LOGIN, EMAIL, LOCALE, FIRST_NAME, LAST_NAME, NOTES, ACTIVE, ADMIN, SOURCE, EXTERNAL);
		/** All fields combined. */
	...
	public static final class Queries {
		...
		public static final String DETACH_FROM_API =
				"DELETE FROM s_user_s_apis WHERE s_user_id IN (SELECT id FROM s_user WHERE "+Fields.LOGIN+"=:"+Fields.LOGIN+" )";
