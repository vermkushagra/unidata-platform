...
/**
 * The Class ModelAuditAction.
 */
public abstract class ModelAuditAction implements AuditAction{
	
	/* (non-Javadoc)
	 * @see com.unidata.mdm.backend.service.audit.actions.AuditAction#getSubsystem()
	 */
	@Override
	public SubSystem getSubsystem() {
		return SubSystem.META;
	}
