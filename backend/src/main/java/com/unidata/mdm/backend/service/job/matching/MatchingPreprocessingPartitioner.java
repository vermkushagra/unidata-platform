...
public class MatchingPreprocessingPartitioner implements Partitioner {
    /**
     * Logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(MatchingPreprocessingPartitioner.class);
    /**
     * Job util
     */
    @Autowired
    ...
    private String jobRunTimestamp;
