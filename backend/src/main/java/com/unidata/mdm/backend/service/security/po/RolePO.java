...
public class RolePO extends BaseSecurityPO implements Serializable {
    ...
    /** The S resources. */
    private List<ResourceRightPO> connectedResourceRights;
     ...
     * Property values.
     */
    private transient List<RolePropertyValuePO> properties;
...
//    private List<LabelAttributeValuePO> labelAttributeValues;
    ...
    public List<ResourceRightPO> getConnectedResourceRights() {
        if(this.connectedResourceRights == null){
            this.connectedResourceRights = new ArrayList<>();
        }
