...
public class DataUtils {
            ...
            for (Attribute attr : dr.getAllAttributes()) {
                switch (attr.getAttributeType()) {
                    ...
                    case CODE:
                        ...
                        break;
                    case COMPLEX: {
                        for (DataRecord child : ((ComplexAttribute) attr)) {
    ...
    /**
     * Trivial naive first level records difference. Tells, whether there is at least one difference.
    ...
    public static boolean hasDiff(String entityName, DataRecord newRecord, DataRecord oldRecord) {
        ...
        Map<TypeOfChange, Map<String, Attribute>> attrsDiff =  createDiffTable(newRecord, oldRecord, wrapper, false, true);
    ...
    public static DataRecord simpleDataDiff(String entityName, DataRecord newRecord, DataRecord oldRecord, DataRecord prevMatch) {
        ...
        Map<TypeOfChange, Map<String, Attribute>> attrsDiff =  createDiffTable(newRecord, oldRecord, wrapper, false, false);
    ...
    public static Map<String, Map<TypeOfChange, Attribute>> simpleDataDiffAsAttributesTable(
        ...
        Map<TypeOfChange, Map<String, Attribute>> attrsDiff = createDiffTable(newRecord, oldRecord, wrapper, collectPrevious, false);
    ...
    private static Map<TypeOfChange, Map<String, Attribute>> createDiffTable(
            DataRecord newAttrs, DataRecord oldAttrs, AttributesWrapper wrapper, boolean collectOld, boolean stopOnFirstHit) {
        ...
        for (Attribute update : newAttrs.getAllAttributes()) {
            ...
            if (update.getAttributeType() == AttributeType.COMPLEX) {
                ...
                if (current == null) {
                    ...
                    if (stopOnFirstHit) { break; } else { continue; }
                }
