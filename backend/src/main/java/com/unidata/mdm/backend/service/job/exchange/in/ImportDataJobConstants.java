...
public class ImportDataJobConstants extends JobCommonParameters {
     ...
     * Param 'skipMove'.
     */
    public static final String PARAM_SKIP_MOVE = "skipMove";
    /**
     * Param 'initialLoad'.
     */
    ...
    /**
     * Param 'resolve by matching'.
     */
    public static final String PARAM_RESOLVE_BY_MATCHING = "resolveByMatching";
    /**
     ...
     */
    public static final String PROCESSING_BATCH_CRASHES = "processingBatchCrashes";
