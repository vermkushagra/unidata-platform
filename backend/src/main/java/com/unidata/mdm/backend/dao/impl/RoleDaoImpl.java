...
public class RoleDaoImpl extends AbstractDaoImpl implements RoleDao {
    ...
    private final String selectRolesWithProperties;
    private final String selectRolesLabels;
    private final String selectRolesResourceRights;
    private final String deleteRolesByName;
    private final String deleteRolesRightsByRolesNames;
    private final String deleteUsersRolesByRolesNames;
    private final String deleteRolesPropertiesByRolesNames;
    private final String selectRolesWithPropertiesByNames;
    ...
    public RoleDaoImpl(
        ...
        selectRolesWithProperties = sql.getProperty("SELECT_ROLES_WITH_PROPERTIES");
        selectRolesLabels = sql.getProperty("SELECT_ROLES_LABELS");
        selectRolesResourceRights = sql.getProperty("SELECT_ROLES_RESOURCE_RIGHTS");
        deleteRolesByName = sql.getProperty("DELETE_ROLES_BY_NAME");
        deleteRolesRightsByRolesNames = sql.getProperty("DELETE_ROLES_RIGHTS_BY_NAME");
        deleteUsersRolesByRolesNames = sql.getProperty("DELETE_USERS_ROLES_BY_ROLES_NAMES");
        deleteRolesPropertiesByRolesNames = sql.getProperty("DELETE_ROLES_PROPERTIES_BY_ROLES_NAMES");

        selectRolesWithPropertiesByNames = sql.getProperty("SELECT_ROLES_WITH_PROPERTIES_BY_ROLES_NAMES");
    ...
    public void removeRolesByName(final List<String> roles) {
        if (CollectionUtils.isNotEmpty(roles)) {
            namedJdbcTemplate.update(deleteRolesRightsByRolesNames, Collections.singletonMap("names", roles));
            namedJdbcTemplate.update(deleteUsersRolesByRolesNames, Collections.singletonMap("names", roles));
            namedJdbcTemplate.update(deleteRolesPropertiesByRolesNames, Collections.singletonMap("names", roles));
            namedJdbcTemplate.update(deleteRolesByName, Collections.singletonMap("names", roles));
        }
    }
    ...
    public Collection<RolePO> loadRoles(final List<String> rolesNames) {
        ...
        return namedJdbcTemplate.query(
                ...
                Collections.singletonMap("names", rolesNames),
