...
/**
 * The Class ModelDraftRemoveAuditAction.
 */
public class ModelDraftRemoveAuditAction extends ModelAuditAction {
	...
	public void enrichEvent(Event event, Object... input) {
		event.putDetails("Сброс черновика");
