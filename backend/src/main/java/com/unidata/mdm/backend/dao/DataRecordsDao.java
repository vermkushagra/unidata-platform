...
public interface DataRecordsDao {
     ...
     * @return keys.
     */
    Map<Object, List<RecordKeysPO>> loadRecordKeys(Map<IdSetType, List<Object>> ids);
    /**
    ...
    /**
     * Wipes origin data (char data, binary data, vistory and origin) from the storage.
     * @param originIds list to remove
     * @return true, if successful, false otherwise
     */
    boolean wipeOriginRecords(List<String> originIds);

    /**
     * Wipes etalon data (char data, binary data and etalon) from the storage.
     * @param etalonIds list to remove
     * @return true, if successful, false otherwise
     */
    boolean wipeEtalonRecords(List<String> etalonIds);
