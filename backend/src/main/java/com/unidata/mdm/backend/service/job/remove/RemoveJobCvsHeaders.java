...
/**
 * Cvs headers for remove job!
 */
public enum RemoveJobCvsHeaders implements CvsElementExtractor<SearchResultHitDTO> {
     ...
     */
    RemoveJobCvsHeaders(String header, AuditHeaderField linkedAuditField) {
        this.header = header;
