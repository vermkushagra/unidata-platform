...
public class SearchRestService extends AbstractRestService {
    ...
    public Response comboSearch(SearchComplexRO request) {
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "Request processed"),
            @ApiResponse(code = 500, message = "Error occurred", response = ErrorResponse.class)})
    public Response formSearch(SearchComplexRO request) {
    ...
    @POST
    @ElementClass(response = SearchResultRO.class)
    @ApiOperation(value = "Общий унифицированный поисковый запрос.", notes = "", response = SearchResultRO.class)
    @ApiResponses({@ApiResponse(code = 200, message = "Request processed"),
            @ApiResponse(code = 500, message = "Error occurred", response = ErrorResponse.class)})
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "Request processed"),
            @ApiResponse(code = 500, message = "Error occurred", response = ErrorResponse.class)})
    public Response simpleSearch(SearchComplexRO request) {
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "Request processed"),
                          @ApiResponse(code = 500, message = "Error occurred", response = ErrorResponse.class)})
    public Response complexSearch(SearchComplexRO request) {
        ...
        try {
            ...
            final SearchRequestContext[] subCtx = request.getSupplementaryRequests().stream()
                    .map(SearchRequestConverters::from)
                    .filter(Objects::nonNull)
                    .toArray(SearchRequestContext[]::new);
    ...
    public Response saytSearch(SearchComplexRO request) {
