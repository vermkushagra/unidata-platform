...
/**
 * Code from {@link org.quartz.CronExpression} in order to gain access to parsed expression and objects.
 */
class CronExpressionAdaptor {
    ...
    CronExpressionAdaptor(String cronExpression) throws ParseException {
