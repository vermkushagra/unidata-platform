...
public class TriggerExecutionListener implements JobExecutionListener {
    ...
    private int getTriggerTimeout() {
        if (triggerTimeout == null) {
            final String timeout = ConfigurationService.getSystemStringPropertyWithDefault(
                    ConfigurationConstants.JOB_TRIGGER_START_TIMEOUT_PROPERTY, String.valueOf(DEFAULT_TRIGGER_START_TIMEOUT));
