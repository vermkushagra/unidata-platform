...
public class ClassifierKeysPO {
     ...
     * Origin node name.
     */
    public static final String FIELD_ORIGIN_NODE_NAME = "origin_node_name";
    /**
     * Origin node code.
     */
    public static final String FIELD_ORIGIN_NODE_CODE = "origin_node_code";
    /**
     * Origin status.
     */
    ...
    public void setOriginNodeName(String nodeName) {
        this.originNodeName = nodeName;
    }

    public String getOriginNodeCode() {
        return originNodeCode;
    }

    public void setOriginNodeCode(String nodeCode) {
        this.originNodeCode = nodeCode;
    }
}
