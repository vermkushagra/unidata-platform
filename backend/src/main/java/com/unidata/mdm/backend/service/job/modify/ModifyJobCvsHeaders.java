...
public enum ModifyJobCvsHeaders implements CvsElementExtractor<SearchResultHitDTO> {
    ETALON_ID("app.job.batch.modify.report.id", AuditHeaderField.ETALON_ID) {
        @Nonnull
        @Override
    ...
    OPERATION_RESULT("app.job.batch.modify.report.result", AuditHeaderField.SUCCESS) {
        @Nonnull
        @Override
        public String getElement(SearchResultHitDTO hit) {
            SearchResultHitFieldDTO field = hit.getFieldValue(getLinkedAuditField().getField());
    ...
    DETAILS("app.job.batch.modify.report.details", AuditHeaderField.DETAILS) {
        @Nonnull
        @Override
        public String getElement(SearchResultHitDTO hit) {
            SearchResultHitFieldDTO field = hit.getFieldValue(getLinkedAuditField().getField());
     ...
     */
    private static final String SUCCESS_MODIFYING = "app.job.batch.modify.report.result.success";
    /**
     * Failed detail message
     */
    private static final String FAILED_MODIFYING = "app.job.batch.modify.report.result.failed";
    /**
     * Header name
     */
     ...
     */
    ModifyJobCvsHeaders(String header, AuditHeaderField linkedAuditField) {
        this.header = header;
