...
public abstract class AbstractEntityDefinitionConverter {
     ...
     *            the source
     */
    public static List<SimpleAttributeDefinition> toSimpleAttrs(List<SimpleAttributeDef> source, String securityPath) {
     ...
     *            the source
     */
    public static List<ArrayAttributeDefinitionRO> toArrayAttrs(List<ArrayAttributeDef> source, String securityPath) {
