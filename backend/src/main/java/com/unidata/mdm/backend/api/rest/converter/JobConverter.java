...
public class JobConverter {
    ...
    public static List<JobParameterDTO> convertParamPoToDto(final List<JobParameterPO> parameterPOs) {
        ...
        for (final JobParameterPO po : parameterPOs) {
            ...
            switch (po.getType()) {
                case STRING:
                    dto = new JobParameterDTO(po.getName(), po.getStringValue());
                    break;
                case DATE:
                    dto = new JobParameterDTO(po.getName(), po.getDateValue());
                    break;
                case LONG:
                    dto = new JobParameterDTO(po.getName(), po.getLongValue());
                    break;
                case DOUBLE:
                    dto = new JobParameterDTO(po.getName(), po.getDoubleValue());
                    break;
                case BOOLEAN:
                    dto = new JobParameterDTO(po.getName(), po.getBooleanValue());
                    break;
                default:
                    dto = null;
            }
    ...
    public static List<JobParameterRO> convertParamDtoToRo(final List<JobParameterDTO> parameterDTOs) {
        ...
        for (final JobParameterDTO dto : parameterDTOs) {
            ...
            switch (dto.getType()) {
                case STRING:
                    ro = new JobParameterRO(dto.getName(), dto.getStringValue());
                    break;
                case DATE:
                    ro = new JobParameterRO(dto.getName(), dto.getDateValue());
                    break;
                case LONG:
                    ro = new JobParameterRO(dto.getName(), dto.getLongValue());
                    break;
                case DOUBLE:
                    ro = new JobParameterRO(dto.getName(), dto.getDoubleValue());
                    break;
                case BOOLEAN:
                    ro = new JobParameterRO(dto.getName(), dto.getBooleanValue());
                    break;
                default:
                    ro = null;
            }
    ...
    public static List<JobParameterDTO> convertParamRoToDto(final List<JobParameterRO> parameterROs) {
        ...
        for (final JobParameterRO ro : parameterROs) {
            ...
            switch (ro.getType()) {
                case STRING:
                    dto = new JobParameterDTO(ro.getName(), ro.getStringValue());
                    break;
                case DATE:
                    dto = new JobParameterDTO(ro.getName(), ro.getDateValue());
                    break;
                case LONG:
                    dto = new JobParameterDTO(ro.getName(), ro.getLongValue());
                    break;
                case DOUBLE:
                    dto = new JobParameterDTO(ro.getName(), ro.getDoubleValue());
                    break;
                case BOOLEAN:
                    dto = new JobParameterDTO(ro.getName(), ro.getBooleanValue());
                    break;
                default:
                    dto = null;
            }
    ...
    private static List<JobParameterPO> convertParamDtoToPo(final List<JobParameterDTO> parameterDTOs) {
        ...
        for (final JobParameterDTO dto : parameterDTOs) {
            ...
            switch (dto.getType()) {
                case STRING:
                    po = new JobParameterPO(dto.getName(), dto.getStringValue());
                    break;
                case DATE:
                    po = new JobParameterPO(dto.getName(), dto.getDateValue());
                    break;
                case LONG:
                    po = new JobParameterPO(dto.getName(), dto.getLongValue());
                    break;
                case DOUBLE:
                    po = new JobParameterPO(dto.getName(), dto.getDoubleValue());
                    break;
                case BOOLEAN:
                    po = new JobParameterPO(dto.getName(), dto.getBooleanValue());
                    break;
                default:
                    po = null;
            }
