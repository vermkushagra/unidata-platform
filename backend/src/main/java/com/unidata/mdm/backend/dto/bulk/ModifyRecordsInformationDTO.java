 ...
 * Configuration container, specific to modify operation.
 */
public class ModifyRecordsInformationDTO implements BulkOperationInformationDTO {

    /**
     * Constructor.
     */
    public ModifyRecordsInformationDTO() {
        super();
    }
