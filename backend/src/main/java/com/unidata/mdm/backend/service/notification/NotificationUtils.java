...
import com.unidata.mdm.api.RestoreActionType;
...
public class NotificationUtils {
     ...
     * @param etalonRecords timeline
     * @param operationId     the operation id
     * @return the unidata message def
     */
    public static final UnidataMessageDef createEtalonSoftDeleteNotification(
            EtalonKey etalonRecordKey, List<OriginKey> originKeys, Collection<EtalonRecord> etalonRecords, String operationId) {
        ...
        return JaxbUtils.getApiObjectFactory().createUnidataMessageDef()
                ...
                .withSoftDeleteEventDetails(
                        JaxbUtils.getApiObjectFactory().createSoftDeleteEventDetailsDef()
                                .withEtalonKey(to(etalonRecordKey))
                                .withEtalonRecord(etalonRecords.stream()
                                        .map(et -> to(et, et.getInfoSection(), com.unidata.mdm.data.EtalonRecord.class))
     ...
     * @return the unidata message def
     */
    public static final UnidataMessageDef createEtalonPeriodSoftDeleteNotification(
            EtalonKey etalonRecordKey, List<OriginKey> originKeys, Collection<EtalonRecord> etalonRecords, String operationId) {
    ...
    public static UnidataMessageDef createEtalonRestoreNotification(
            EtalonKey etalonKey, List<OriginKey> originKeys, Collection<EtalonRecord> records, String operationId) {
        ...
        return JaxbUtils.getApiObjectFactory().createUnidataMessageDef()
                ...
                .withRestoreEventDetails(JaxbUtils.getApiObjectFactory().createRestoreEventDetailsDef()
                        ...
                        .withEtalonRecord(records.stream()
                                .map(et -> to(et, et.getInfoSection(), com.unidata.mdm.data.EtalonRecord.class))
                                .collect(Collectors.toList()))
                        .withSupplementaryKeys(originKeys.stream().map(JaxbDataRecordUtils::to).collect(toList()))
                        .withRestoreActionType(RestoreActionType.RESTORE_ETALON));
    }

    public static UnidataMessageDef createEtalonPeriodRestoreNotification(
            EtalonKey etalonKey, List<OriginKey> originKeys, Collection<EtalonRecord> records, String operationId) {
        ...
        return JaxbUtils.getApiObjectFactory().createUnidataMessageDef()
                ...
                .withRestoreEventDetails(JaxbUtils.getApiObjectFactory().createRestoreEventDetailsDef()
                        ...
                        .withEtalonRecord(records.stream()
                                ...
                                .collect(Collectors.toList()))
                        .withSupplementaryKeys(originKeys.stream().map(JaxbDataRecordUtils::to).collect(toList()))
                        .withRestoreActionType(RestoreActionType.RESTORE_ETALON_PERIOD));
    }
    ...
    public static NotificationCacheMessage unmarshalNotificationCacheMessage(String data) throws IOException {
        return JsonUtils.read(data, NotificationCacheMessage.class);
    }
