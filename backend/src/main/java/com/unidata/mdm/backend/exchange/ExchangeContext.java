                ...
                if (values.length > 0) {
                    ...
                    for (int i = 0; i < values.length; i++) {
                        for (Action a : Action.values()) {
                            if (a.name().equalsIgnoreCase(values[i].trim())) {
                                actions.add(a);
                                break;
                            }
                        }
                ...
                if (values.length > 0) {
                    ...
                    for (int i = 0; i < values.length; i++) {
                        for (InputFormat f : InputFormat.values()) {
                            if (f.name().equalsIgnoreCase(values[i].trim())) {
                                formats.add(f);
                                break;
                            }
                        }
                ...
                if (StringUtils.equals(argv[i], "--" + param.getParamName())) {
                    switch (param) {
                        ...
                        case PARAM_SEARCH_FORCE_CREATE:
                            configuration.searchForceCreate = i + 1 < argv.length ? Boolean.parseBoolean(argv[++i].trim()) : false;
                            break;
                        ...
                        case PARAM_MIGRATE_BY_CLASSES:
                            ...
                            if (migrationClassesString != null) {
                                ...
                                for (String migrationClass : classes) {
