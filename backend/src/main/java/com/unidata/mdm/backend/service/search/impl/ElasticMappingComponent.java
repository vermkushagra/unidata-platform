                    ...
                    .startObject(classifierDataContext.getType().getName())
                        ...
                        .startObject("properties")
                            ...
                            .startObject(ClassifierDataHeaderField.FIELD_FROM.getField())
                                .field("type", "date")
                                .field("format", "date_time||epoch_millis")
                            ...
                            .startObject(classifierName)
                                .startObject("properties")
                                    ...
                                    .startObject(ClassifierDataHeaderField.FIELD_NODES.getField())
                                        ...
                                        .endObject()
                                    .endObject()
                                    .startObject(ClassifierDataHeaderField.FIELD_CLS_NESTED_ATTRS.getField())
                                        .field("type", "nested")
                                        .startObject("properties")
                                            .startObject(ClassifierDataHeaderField.FIELD_CLS_ATTR_NAME.getField())
                                                .field("type", "keyword")
                                            .endObject()
                                            .startObject(ClassifierDataHeaderField.FIELD_CLS_ATTR_VALUE_PREFIX.getField() + "date")
                                                .field("type", "date")
                                            .endObject()
                                            .startObject(ClassifierDataHeaderField.FIELD_CLS_ATTR_VALUE_PREFIX.getField() + "time")
                                                .field("type", "date")
                                                .field("format", "'T'HH:mm:ss||'T'HH:mm:ss.SSS||HH:mm:ss||HH:mm:ss.SSS||'T'HH:mm:ssZZ||'T'HH:mm:ss.SSSZZ||HH:mm:ssZZ||HH:mm:ss.SSSZZ")
                                            .endObject()
                                            .startObject(ClassifierDataHeaderField.FIELD_CLS_ATTR_VALUE_PREFIX.getField() + "double")
                                                .field("type", "double")
                                            .endObject()
                                            .startObject(ClassifierDataHeaderField.FIELD_CLS_ATTR_VALUE_PREFIX.getField() + "boolean")
                                                .field("type", "boolean")
                                            .endObject()
                                            .startObject(ClassifierDataHeaderField.FIELD_CLS_ATTR_VALUE_PREFIX.getField() + "long")
                                                .field("type", "long")
                                            .endObject()
                                            .startObject(ClassifierDataHeaderField.FIELD_CLS_ATTR_VALUE_PREFIX.getField() + "string")
                                                .field("type", "string")
                                                .field("analyzer", SearchUtils.DEFAULT_STRING_ANALYZER_NAME)
                                                .startObject("fields")
                                                    .startObject(SearchUtils.NAN_FIELD)
...
//
//                    final AbstractClassifierAttributeDef attrDef
//                            = conversionService.convert(classifierAttr, AbstractClassifierAttributeDef.class);
//
//                    String originalType = attrDef.getValueType() != null ?
//                            attrDef.getValueType().name() :
//                            (attrDef.getLookupEntityCodeAttributeType() != null ?
//                                    attrDef.getLookupEntityCodeAttributeType().name() :
//                                    extractTypeFromCodeEntity(attrDef.getLookupEntityType())
//                            );
...
//                }
    ...
    private String extractTypeFromCodeEntity(String lookupEntityType) {
        if (lookupEntityType == null) {
            return null;
        }
        return metaModelService.getLookupEntityById(lookupEntityType).getCodeAttribute().getSimpleDataType().name();
    }
        ...
        try (XContentBuilder relationBuilder = XContentFactory.jsonBuilder()) {
            relationBuilder.startObject()
                    .startObject(forEntity.getType().getName())
                        ...
                        .field("dynamic", false)
                        .startObject("properties")
                            // TODO: Remove relation name from the mapping, as it causes many problems (i. e. ResultHitModifier dealing with remove prefix)
                            // and has no value.
            ...
            LOGGER.info("Index not found exception for relation with name  {}", relation.getName());
            return false;
        } catch (Exception e) {
            LOGGER.warn("Error during putting etalon mapping, {}", e);
            return false;
    ...
    private XContentBuilder processHeader(XContentBuilder builder)
        ...
        builder
            ...
            .startObject(RecordHeaderField.FIELD_DELETED.getField())
                ...
                .field("null_value", false)
            .endObject()
            .startObject(RecordHeaderField.FIELD_INACTIVE.getField())
                .field("type", "boolean")
                .field("null_value", false)
            .endObject()
            .startObject(RecordHeaderField.FIELD_OPERATION_TYPE.getField())
                .field("type", "string")
                .field("index", SearchUtils.NONE_STRING_ANALYZER_NAME)
                .field("doc_values", true)
            .endObject();
     ...
     */
    private void dqErrorsMapping(XContentBuilder builder) throws IOException {
            ...
            .startObject(DQHeaderField.getParentField())
                ...
                .startObject("properties")
                    ...
                    .startObject(DQHeaderField.CATEGORY.getDirectField())
                        .field("type", "keyword")
                    .endObject()
                    .startObject(DQHeaderField.EXECUTION_MODE.getDirectField())
                        .field("type", "keyword")
                    .endObject()
                    .startObject(DQHeaderField.FIELD.getDirectField())
                        .field("type", "keyword")
                    .endObject()
                    .startObject(DQHeaderField.PATHS.getDirectField())
                        .field("type", "keyword")
                    .endObject()
                .endObject()
            .endObject();
