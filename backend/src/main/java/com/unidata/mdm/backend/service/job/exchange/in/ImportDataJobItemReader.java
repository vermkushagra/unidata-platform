...
//            super.setSql(ImportDataJobUtils.getSql(exchangeEntity, offset, blockSize, databaseVendor));
...
//            super.setSql(ImportDataJobUtils.getSql(exchangeRelation, offset, blockSize, databaseVendor));
