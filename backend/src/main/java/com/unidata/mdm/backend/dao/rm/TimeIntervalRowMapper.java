...
public class TimeIntervalRowMapper implements RowMapper<TimeIntervalPO> {
     ...
     * Operation type.
     */
    private static final int IDX_OPERATION_TYPE = 7;
            ...
            for (int i = 0; i < lines.length; i++) {
                ...
                try {
                    ...
                    if (fields != null) {
                        ...
                        if (fields.length-1 >= IDX_OPERATION_TYPE && StringUtils.isNotBlank(operationType = fields[IDX_OPERATION_TYPE].trim())) {
                            contributor.setOperationType((VistoryOperationType.valueOf(operationType)));
                        }
