...
public class SingleValueAttributeImpl extends AbstractSingleValueAttribute {
    ...
    public void setStringValue(ObjectFactory factory, String value) {
        // Escape special characters for String attributes to avoid marshalling with invalid symbols in XML.
    ...
    */
    ...
    public <T> T getValue() {
        ...
        if (type != null) {
            switch (type) {
                case STRING:
                    // Unescape special characters for String attribute.
                    return stringValue != null ? (T) StringEscapeUtils.unescapeXml(stringValue.getValue()) : null;
                case INTEGER:
