...
public class CFSubstractTest {
	...
	public void testGetDefinition() {
		...
		assertEquals("Разность", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.math.CFSubstract", cf.getDefinition().getJavaClass());
