...
public class CFTrimTest {
	...
	public void testGetDefinition() {
		...
		assertEquals("УбратьПробелы", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.string.CFTrim", cf.getDefinition().getJavaClass());
