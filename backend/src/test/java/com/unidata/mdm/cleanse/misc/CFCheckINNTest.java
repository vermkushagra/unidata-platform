...
public class CFCheckINNTest {
	...
	public void testGetDefinition() {
		...
		assertEquals("ПроверкаИНН", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.misc.CFCheckINN", cf.getDefinition().getJavaClass());
