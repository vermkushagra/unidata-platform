 ...
 *
 */
public class CFCCheckLengthTest {
	/** The cf. */
	...
	public void testExecuteTRUEInteger() throws Exception {
		...
		StringSimpleAttributeImpl port1 = new StringSimpleAttributeImpl("port1", "abcd");
		input.put("port1", port1);
		IntegerSimpleAttributeImpl port2 = new IntegerSimpleAttributeImpl("port3", 2l);
	...
	public void testExecuteTRUEString() throws Exception {
		Map<String, Object> input = new HashMap<>();
		StringSimpleAttributeImpl port1 = new StringSimpleAttributeImpl("port1", "abcd1");
		input.put("port1", port1);
		IntegerSimpleAttributeImpl port2 = new IntegerSimpleAttributeImpl("port2", 5l);
		input.put("port2", port2);
		IntegerSimpleAttributeImpl port3 = new IntegerSimpleAttributeImpl("port3", 5l);
		input.put("port3", port3);
		Map<String, Object> output = cf.execute(input);
		assertNotNull(output);
		assertEquals(1, output.size());
	...
	public void testExecuteFALSENumber() throws Exception {
		...
		StringSimpleAttributeImpl port1 = new StringSimpleAttributeImpl("port1", "abcd");
		input.put("port1", port1);
		IntegerSimpleAttributeImpl port2 = new IntegerSimpleAttributeImpl("port3", 12l);
		input.put("port2", port2);
		IntegerSimpleAttributeImpl port3 = new IntegerSimpleAttributeImpl("port3", 120l);
		input.put("port3", port3);
		Map<String, Object> output = cf.execute(input);
	...
	public void testExecuteFALSEString() throws Exception {
		...
		StringSimpleAttributeImpl port1 = new StringSimpleAttributeImpl("port1", "abcd");
		input.put("port1", port1);
		IntegerSimpleAttributeImpl port2 = new IntegerSimpleAttributeImpl("port3", 5l);
		input.put("port2", port2);
		IntegerSimpleAttributeImpl port3 = new IntegerSimpleAttributeImpl("port3", 5l);
		input.put("port3", port3);
		Map<String, Object> output = cf.execute(input);
	...
	public void testGetDefinition() {
		...
		assertEquals("ПроверкаДлиныСтроки", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.string.CFCCheckLength", cf.getDefinition().getJavaClass());
