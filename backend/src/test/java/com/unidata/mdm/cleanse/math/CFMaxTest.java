...
public class CFMaxTest {
	...
	public void testExecute() throws Exception {
		...
		assertEquals(new Double(12d), ((NumberSimpleAttributeImpl) output.get("port1")).getValue());
	...
	public void testGetDefinition() {
		...
		assertEquals("Максимум", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.math.CFMax", cf.getDefinition().getJavaClass());
