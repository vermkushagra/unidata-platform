...
public class CFMinTest {
	...
	public void testExecute() throws Exception {
		...
		assertEquals(new Double(11d), ((NumberSimpleAttributeImpl) output.get("port1")).getValue());
	...
	public void testGetDefinition() {
		...
		assertEquals("Минимум", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.math.CFMin", cf.getDefinition().getJavaClass());
