 ...
 *
 */
public class CFFormatStringTest {
	/** The cf. */
	...
	public void testExecuteTRUEString() throws Exception {
		...
		StringSimpleAttributeImpl port1 = new StringSimpleAttributeImpl("port1", "123");
		input.put("port1", port1);
		StringSimpleAttributeImpl port2 = new StringSimpleAttributeImpl("port2", "String : %s");
		...
		assertEquals("String : 123", ((StringSimpleAttributeImpl) output.get("port1")).getValue());
	...
	public void testGetDefinition() {
		...
		assertEquals("Форматировать", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.string.CFFormatString", cf.getDefinition().getJavaClass());
