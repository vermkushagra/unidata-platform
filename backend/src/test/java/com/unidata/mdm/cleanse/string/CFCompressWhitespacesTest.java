 ...
 *
 */
public class CFCompressWhitespacesTest {
	...
	public void testGetDefinition() {
		...
		assertEquals("УбратьЛишниеПробелы", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.string.CFCompressWhitespaces", cf.getDefinition().getJavaClass());
	...
	@Before
	public void init() {
		this.cf = new CFCompressWhitespaces();
	}
}
