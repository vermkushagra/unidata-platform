...
public class CFIsEmptyTest {
	...
	public void testGetDefinition() {
		...
		assertEquals("IsEmpty", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.logic.CFIsEmpty", cf.getDefinition().getJavaClass());
