...
public class CFRoundTest {
	...
	public void testExecute() throws Exception {
		...
		NumberSimpleAttributeImpl port1 = new NumberSimpleAttributeImpl("port1", 12.1234567890d);
		...
		assertEquals(new Double(12.12346d), ((NumberSimpleAttributeImpl) output.get("port1")).getValue());
	...
	public void testExecuteFailure() throws Exception {
		Map<String, Object> input = new HashMap<>();
		NumberSimpleAttributeImpl port1 = new NumberSimpleAttributeImpl("port1", null);
		NumberSimpleAttributeImpl port2 = new NumberSimpleAttributeImpl("port2", null);
		input.put("port1", port1);
		input.put("port2", port2);
		Map<String, Object> output = cf.execute(input);
		assertNotNull(output);
	...
	public void testGetDefinition() {
		...
		assertEquals("Округлить", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.math.CFRound", cf.getDefinition().getJavaClass());
