...
public class CFSumTest {
	...
	public void testGetDefinition() {
		...
		assertEquals("Сумма", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.math.CFSum", cf.getDefinition().getJavaClass());
