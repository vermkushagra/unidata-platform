 ...
 *
 */
public class CFCheckRangeNumberTest {
	...
	public void testExecuteTRUE() throws Exception {
		...
		NumberSimpleAttributeImpl port1 = new NumberSimpleAttributeImpl("port1", 12.12);
		NumberSimpleAttributeImpl port2 = new NumberSimpleAttributeImpl("port2", 12.11);
		NumberSimpleAttributeImpl port3 = new NumberSimpleAttributeImpl("port3", 12.13);
	...
	public void testExecuteFALSE() throws Exception {
		Map<String, Object> input = new HashMap<>();
		NumberSimpleAttributeImpl port1 = new NumberSimpleAttributeImpl("port1", 12.12);
		NumberSimpleAttributeImpl port2 = new NumberSimpleAttributeImpl("port2", 12.13);
		NumberSimpleAttributeImpl port3 = new NumberSimpleAttributeImpl("port3", 12.14);
		input.put("port1", port1);
		input.put("port2", port2);
		input.put("port3", port3);
		Map<String, Object> output = cf.execute(input);
	...
	public void testGetDefinition() {
		...
		assertEquals("ПроверкаДиапазонаДробныхЧисел", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.math.CFCheckRangeNumber", cf.getDefinition().getJavaClass());
	...
	public void testInputPorts() {
		...
		assertEquals(SimpleDataType.NUMBER, cf.getDefinition().getInputPorts().get(2).getDataType());
	...
	@Before
	public void init() {
		this.cf = new CFCheckRangeNumber();
