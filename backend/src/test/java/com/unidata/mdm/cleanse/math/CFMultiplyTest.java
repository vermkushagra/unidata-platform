...
public class CFMultiplyTest {
	...
	public void testGetDefinition() {
		...
		assertEquals("Произведение", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.math.CFMultiply", cf.getDefinition().getJavaClass());
