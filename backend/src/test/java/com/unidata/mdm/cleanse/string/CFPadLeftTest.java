...
public class CFPadLeftTest {
	...
	public void testGetDefinition() {
		...
		assertEquals("ВыровнятьСлева", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.string.CFPadLeft", cf.getDefinition().getJavaClass());
