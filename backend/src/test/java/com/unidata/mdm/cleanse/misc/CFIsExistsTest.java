...
public class CFIsExistsTest {
	...
	public void testExecuteTRUE() throws Exception {
		...
		StringSimpleAttributeImpl port1 = new StringSimpleAttributeImpl("port1", "7707083893");
	...
	public void testGetDefinition() {
		...
		assertEquals("ПроверкаСуществованияАтрибута", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.misc.CFIsExists", cf.getDefinition().getJavaClass());
	...
	public void testInputPorts() {
		...
		assertEquals(SimpleDataType.ANY, cf.getDefinition().getInputPorts().get(0).getDataType());
