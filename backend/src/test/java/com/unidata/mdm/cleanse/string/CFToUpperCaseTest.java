 ...
 *
 */
public class CFToUpperCaseTest {
	/** The cf. */
	...
	public void testGetDefinition() {
		...
		assertEquals("ВерхнийРегистр", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.string.CFToUpperCase", cf.getDefinition().getJavaClass());
