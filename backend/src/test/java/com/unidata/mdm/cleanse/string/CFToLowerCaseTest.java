 ...
 *
 */
public class CFToLowerCaseTest {
	/** The cf. */
	...
	public void testGetDefinition() {
		...
		assertEquals("НижнийРегистр", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.string.CFToLowerCase", cf.getDefinition().getJavaClass());
