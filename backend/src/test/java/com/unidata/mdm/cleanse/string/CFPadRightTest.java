...
public class CFPadRightTest {
	...
	public void testExecuteTRUEInteger() throws Exception {
		...
		IntegerSimpleAttributeImpl port2 = new IntegerSimpleAttributeImpl("port2", 20l);
	...
	public void testExecuteFALSENumber() throws Exception {
		...
		input.put("port1", port1);
		IntegerSimpleAttributeImpl port2 = new IntegerSimpleAttributeImpl("port2", 10l);
		input.put("port2", port2);
		Map<String, Object> output = cf.execute(input);
		assertNotNull(output);
		assertEquals(1, output.size());
	...
	public void testExecuteFALSEString() throws Exception {
		...
		StringSimpleAttributeImpl port1 = new StringSimpleAttributeImpl("port1", "Test string!");
		input.put("port1", port1);
		IntegerSimpleAttributeImpl port2 = new IntegerSimpleAttributeImpl("port2", 12l);
		input.put("port2", port2);
		Map<String, Object> output = cf.execute(input);
		assertNotNull(output);
		assertEquals(1, output.size());
	...
	public void testGetDefinition() {
		...
		assertEquals("ВыровнятьСправа", cf.getDefinition().getFunctionName());
		assertEquals("com.unidata.mdm.cleanse.string.CFPadRight", cf.getDefinition().getJavaClass());
