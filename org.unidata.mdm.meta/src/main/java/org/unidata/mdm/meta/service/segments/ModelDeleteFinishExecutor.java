...
public class ModelDeleteFinishExecutor extends Finish<DeleteModelRequestContext, VoidPipelineOutput> {
    /**
     * This segment ID.
     */
     ...
     */
    @Override
    public VoidPipelineOutput finish(DeleteModelRequestContext ctx) {
