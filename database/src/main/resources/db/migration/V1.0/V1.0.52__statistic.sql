...
(
  ...
  id serial NOT NULL,
  entity character varying(2044) COLLATE pg_catalog."POSIX" NOT NULL,
...
DROP INDEX IF EXISTS index_at_date;
...
DROP INDEX IF EXISTS index_type;
...
DROP INDEX IF EXISTS index_entity;

CREATE INDEX index_entity
  ON statistic_counters
  USING btree
  (entity);
