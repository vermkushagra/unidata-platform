...
DROP FUNCTION public.ud_fetch_relations_timeline_intervals(uuid, character varying, boolean);

CREATE OR REPLACE FUNCTION public.ud_fetch_relations_timeline_intervals(
  _etalon_id uuid,
...
ALTER FUNCTION public.ud_fetch_relations_timeline_intervals(uuid, character varying, boolean)
OWNER TO postgres;
