...
create index ix_origins_vistory_approval on origins_vistory (approval);

drop index if exists ix_origins_relations_vistory_approval;
create index ix_origins_relations_vistory_approval on origins_relations_vistory (approval);
