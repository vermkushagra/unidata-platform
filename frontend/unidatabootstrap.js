var Unidata = Unidata || window['Unidata'] || {};
...
Unidata.Microloader = Unidata.Microloader || (function () {
    var Microloader = {
        ...
        loadCustomerJson: function (data, nextCallback) {
            var customerUrl = window.customerUrl;
            ...
            Microloader.loadJson(customerUrl + 'customer.json',
                function (jsonData) {
                    try {
                ...
                function () {
                    console.log('Error: can not load customer.json');
        ...
        loadInternationalizationJson: function (data, nextCallback) {
            ...
            customerLng = window.customerConfig.LOCALE;

            languages.push(defaultLng);
            languages.push(customerLng);
...
if (localStorage.getItem('reload_4.7') !== 'reloaded') {
    localStorage.setItem('reload_4.7', 'reloaded');
    window.location.reload();
}

Unidata.Microloader.chain(
    Unidata.Microloader.loadCustomerJson,
    Unidata.Microloader.initUnidataCustomerCustomization,
