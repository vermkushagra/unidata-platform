...
Ext.define('Unidata.view.component.dashboard.entity.items.Counts', {
    ...
    title: Unidata.i18n.t('dashboard>currentState'),
    ...
    tpl: [
        '<ul>',
        '<li class="un-entity-counts-total"><span>' + Unidata.i18n.t('dashboard>totalRecords') + '<b>{TOTAL}</b></span><div class="un-chart-canvas-wrap x-unselectable"><canvas class="un-chart-canvas"></canvas></div></li>',
        '<li class="un-entity-counts-errors"><span>' + Unidata.i18n.t('dashboard>withErrors').toLowerCase() + '<b>{ERRORS}</b></span></li>',
