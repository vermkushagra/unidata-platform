...
Ext.define('Unidata.view.component.search.resultset.Resultset', {
    ...
    resultsetGrid: null,
    pagingToolbar: null,
    toolbarButtonContainer: null, // ссылка на контейнер с кнопками
    selectAllButton: null,
    selectAllAtPageButton: null,
    ...
    dockedItems: [
        {
            ...
            items: [
                {
                    xtype: 'container',
                    reference: 'toolbarButtonContainer',
                    hidden: true,
                    bind: {
                    ...
                    items: [
                        ...
                        {
                            xclass: 'Unidata.view.component.button.RoundButton',
                            reference: 'selectAllAtPageButton',
    ...
    updateSearchQuery: function (newSearchQuery, oldSearchQuery) {
        if (oldSearchQuery) {
            oldSearchQuery.getEntityTerm().unbind('metaRecord', this.setMetaRecord, this);
        }

        if (newSearchQuery) {
            oldSearchQuery.getEntityTerm().bind('metaRecord', this.setMetaRecord, this);
        }
    },
    ...
    initReferences: function () {
        ...
        this.toolbarButtonContainer = this.lookupReference('toolbarButtonContainer');

        this.selectAllButton = this.lookupReference('selectAllButton');
        this.selectAllAtPageButton = this.lookupReference('selectAllAtPageButton');
        this.deselectAllButton = this.lookupReference('deselectAllButton');
    },
