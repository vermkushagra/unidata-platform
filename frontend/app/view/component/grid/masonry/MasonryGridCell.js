...
Ext.define('Unidata.view.component.grid.masonry.MasonryGridCell', {
                    ...
                    menu: {
                        ...
                        defaults: {
                            ...
                            handler: function (menuItem) {
                                this.setWidget(menuItem.widget);
                            }
                        },
    ...
    getWidgetsList: function () {
        ...
        widgetsList = [
            ...
            {
                text: Unidata.i18n.t('masonryGrid>widget.dqerrorsDaily'),
                widget: {
                    xtype: 'component.dashboard.entity.dqerrors.daily'
                }
            }
        ];
    ...
    onResizerDragDeltaChange: function (resizer, deltaX) {
