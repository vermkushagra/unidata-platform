...
Ext.define('Unidata.view.component.dataentity.IndicatorRound', {
    ...
    setRadius: function (radius) {
        var radiusActive = radius * 2;

        // минимальный диаметр активного элемента - 10 т.к. не будет видна индикация
        if (radiusActive < 5) {
            radiusActive = 5;
        }
        ...
        this.setRadiusActive(radiusActive);

        this.setComponentRadius(radius);
    },

    setComponentRadius: function (radius) {
    ...
    setActive: function (active) {
        ...
        if (active) {
            ...
            this.setComponentRadius(this.getRadiusActive());
        } else {
            el.removeCls(CLASS_ACTIVE);
            this.setComponentRadius(this.getRadius());
        }
