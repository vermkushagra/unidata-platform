...
Ext.define('Unidata.view.admin.security.role.RoleEditController', {
    ...
    saveRole: function () {
        ...
        if (form.isValid()) {
            associatedData = currentRole.getAssociatedData(null, {serialize: true, persist: true});
    ...
    compareRelationRights: function (fromEntityName, toEntityName, relationVertex) {
        ...
        relationTypeDisplayName = Unidata.model.data.RelationTimeline.getRelationTypeDisplayName(relationType);
