...
Ext.define('Unidata.view.admin.duplicates.group.GroupTree', {
    ...
    onStoreLoad: function (store, groups, successful, operation) {
        ...
        this.loadClusterRules().then(function (rules) {
            ...
            // это код, потенциально нужный для отображения правил без групп
            // создаём ноды правил без группы
            // Ext.Array.each(rules, function (rule) {
            //     var ruleId = rule.get('id');
            //
            //     // если правило не в группе
            //     if (rulesIdsInGroup.indexOf(ruleId) == -1) {
            //         root.appendChild({
            //             record: rule,
            //             text: rule.get('name'),
            //             ruleId: ruleId,
