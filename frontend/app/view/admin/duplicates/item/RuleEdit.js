...
Ext.define('Unidata.view.admin.duplicates.item.RuleEdit', {
    ...
    initComponent: function () {
        ...
        this.ruleToggleActive = Ext.create('Unidata.view.admin.entity.metarecord.dq.dqrule.ToggleButton', {
            ...
            handler: 'onRuleActiveToggle'
        });

        this.header = {
            items: [this.ruleToggleActive]
        };
    },
    ...
    items: [
        ...
        {
            xtype: 'checkbox',
            reference: 'withPreprocessing',
            boxLabel: Unidata.i18n.t('admin.duplicates>withPreprocessing'),
            bind: {
                value: '{rule.withPreprocessing}'
            }
        },
        {
            xtype: 'checkbox',
            reference: 'autoMerge',
            boxLabel: Unidata.i18n.t('admin.duplicates>ruleAutoMerge'),
            bind: {
