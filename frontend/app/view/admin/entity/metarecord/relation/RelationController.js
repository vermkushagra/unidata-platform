Ext.define('Unidata.view.admin.entity.metarecord.relation.RelationController', {
        ...
        this.getView().lookupReference('relationItemColumn').tpl =
            new Ext.XTemplate('<b>{[this.getRelationDisplayName(values)]}</b> {[this.getRelationTypeDisplayName(values)]}', {
                getRelationTypeDisplayName: function (values) {
                    return Unidata.model.data.Relation.getRelationTypeDisplayName(values.relType);
                },
    ...
    onSelectEntityRelation: function (field, record) {
        ...
        this.loadMetaRecordAndFillDisplayAttributes(relation);
    },

    loadMetaRecordAndFillDisplayAttributes: function (relation) {
        ...
        Unidata.util.api.MetaRecord.getMetaRecord({
            ...
            draft: view.draftMode
                ...
                displayNames = MetaAttributeFormatter.getMainDisplayableAttributeDisplayNames(record);
                defaultValueText = displayNames.join(', ');
                displayAttributeList = view.displayAttributeList;
                displayAttributeList.setDefaultValueText(defaultValueText);

                me.fillDisplayAttributeStore(record);
    ...
    fillDisplayAttributeStore: function (record) {
        var view = this.getView(),
            viewModel = this.getViewModel(),
            displayAttributeList,
            store,
        ...
        displayAttributeList = view.displayAttributeList;
        store = displayAttributeList.getStore();
        Unidata.view.component.AttributeTagField.fillStore(store, record);
