    ...
    formulas: {
        ...
        tabName: {
            ...
            get: function (record) {
                ...
                if (record) {
                    typeName = record.getType() === 'Entity' ? Unidata.i18n.t('glossary:entity') : Unidata.i18n.t('glossary:lookupEntity');
        ...
        isMetaRecordDone: {
            ...
            get: function (getter) {
                return getter.currentRecord && getter.tabAttributeDone && getter.tabConsolidationDone;
            }
        },
        saveButtonEnabled: {
            bind: {
            ...
            get: function (getter) {
                ...
                if (!getter.readOnly && getter.canSave && !getter.saving) {
                    enable = true;
                }
