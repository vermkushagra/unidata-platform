...
Ext.define('Unidata.view.admin.entity.wizard.step.modelimport.SettingsStep', {
                        ...
                        renderer: function (value, metaData, record) {
                            ...
                            if (vertex) {
                                ...
                                if (messages && messages.length) {
                                    ...
                                    return '<span class="un-grid-icon-msg icon-notification-circle"></span>'; // jscs:ignore maximumLineLength
                                }
                            }
    ...
    updateAggregatedCounts: function () {
        ...
        vertexesStore.each(function (vertex) {
            var vertexStatus = vertex.get('status'),
                vertexAction = vertex.get('action'),
                vertexExistence = vertex.get('existence'),
                hasError = false;
        ...
        this.lookupReference('aggregatedCounts').update({
            newCount: newCount,
