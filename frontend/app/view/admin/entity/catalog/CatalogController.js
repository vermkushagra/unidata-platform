...
Ext.define('Unidata.view.admin.entity.catalog.CatalogController', {
    ...
    deleteRecordAllowed: function (record) {
        var view = this.getView(),
            ...
            nonRemovable = view.nonRemovable;
        ...
        if (nonRemovable && nonRemovable[record.get('groupName')] && nonRemovable[record.get('groupName')].length > 0) {
            return false;
        }
    ...
    onButtonSaveClick: function () {
        ...
        promise
            .then(
                ...
                function () {
                    view.showRefreshCatalogOverlay(true);
                    view.setLoading(false);
                }
            )
            .done();
    ...
    refreshCatalogData: function () {
        ...
        if (view.rendered) {
            ...
            view.showRefreshCatalogOverlay(false);
        }
    },
