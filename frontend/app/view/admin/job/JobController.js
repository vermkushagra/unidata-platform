...
Ext.define('Unidata.view.admin.job.JobController', {
    ...
    setJob: function (job, update) {
        ...
        if (me.isDirty()) {
            header = Unidata.i18n.t('admin.job>operationNotSaved');
            message = '<div style=\'width:450px\'>' + Unidata.i18n.t('admin.job>changeOperationWarning') + '</br>' + Unidata.i18n.t('admin.job>confirmChangeOperation') + '</div>';
