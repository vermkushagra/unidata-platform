                        ...
                        items: [
                            {
                                xtype: 'tool',
                                type: 'play',
                                tooltip: Unidata.i18n.t('admin.job>startToolTip'),
                            ...
                            },
                            {
                                xtype: 'tool',
                                type: 'stop',
                                tooltip: Unidata.i18n.t('admin.job>stopToolTip'),
                                handler: 'onStopClick',
                                margin: '0 4',
                                bind: {
                                    hidden: '{!stopAllowed}'
