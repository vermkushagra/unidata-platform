...
Ext.define('Unidata.view.steward.dataviewer.DataViewer', {
    ...
    config: {
        ...
        allowDetachOriginOperation: true,       // флаг указывает разрешено ли выполнять операцию исключения ориндижна из записи
        clusterCount: 0,
        alwaysHideMergeButtons: false,
        saveAtomic: true,                       // флаг атомарного сохранения записи
        selectedInactiveTimeInterval: false
    },

    viewModelAccessors: ['alwaysHideMergeButtons', 'selectedInactiveTimeInterval'],
                ...
                items: [
                    {
                        ...
                        reference: 'dataCard',
                        readOnly: readOnly,
                        diffToDraft: this.getDiffToDraft(),
                        ...
                        listeners: {
                            ...
                            savesuccess: 'onDataCardSaveSuccess',
                            savefailure: 'onDataCardSaveFailure'
                        },
                        bind: {
                    ...
                    },
                    {
                        ...
                        readOnly: readOnly,
                        allowDetachOriginOperation: this.getAllowDetachOriginOperation(),
                        listeners: {
