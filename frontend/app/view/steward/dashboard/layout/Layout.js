Ext.define('Unidata.view.steward.dashboard.layout.Layout', {
    ...
    getDefaultDashboard: function () {
        ...
        defaultDashboard = {
            xclass: 'Unidata.view.component.dashboard.Dashboard',
            grid: {
                xclass: 'Unidata.view.component.grid.masonry.MasonryGrid',
                items: [
                    {
                        xclass: 'Unidata.view.component.grid.masonry.MasonryGridRow',
                        items: [
                            {
                                xclass: 'Unidata.view.component.grid.masonry.MasonryGridCell',
                                items: [
                                    {
                                        xclass: 'Unidata.view.component.dashboard.entity.EntityPanel'
                                    }
                                ],
                                columnIndex: 0,
                                columnsCount: 10
