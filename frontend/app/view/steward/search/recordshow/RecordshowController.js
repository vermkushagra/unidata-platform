Ext.define('Unidata.view.steward.search.recordshow.RecordshowController', {
    ...
    initRouter: function () {
        ...
        // роутинг необходимо производить после подписки на события, которые могут изменять url hash
     ...
     * @param operationId
     */
    createRecordTab: function (etalonId, metaRecord, title, sourceRecord, saveCallback, operationId, drafts) {
        var view = this.getView(),
            dataViewerPanel,
            dataViewerPanelCfg;
    ...
    createRecordTabFromRecord: function (searchHit, metaRecord, drafts) {
        var etalonId,
            recordshowTabPanel,
            title;
        ...
        recordshowTabPanel.createRecordTab(etalonId, metaRecord, title, null, null, null, drafts);
    },
     ...
     */
    onCreateDataRecordButtonClick: function () {
