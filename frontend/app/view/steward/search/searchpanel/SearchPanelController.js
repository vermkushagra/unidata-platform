Ext.define('Unidata.view.steward.search.searchpanel.SearchPanelController', {
    ...
    onResultSetItemClick: function (component, searchHit) {
        ...
        recordshowTabPanel.createRecordTabFromRecord(searchHit, metaRecord);
    },
    ...
    onAllPeriodActualSearchChange: function (allPeriodSearch) {
        ...
        this.allPeriodSearch = allPeriodSearch;

        tab = this.findTableResultSetTab();

        if (tab) {
            tab.setAllPeriodSearch(allPeriodSearch);
        }

        view.resultsetPanel.setAllPeriodSearch(allPeriodSearch);

        if (allPeriodSearch) {
            view.resultsetPanel.setEditMode(view.resultsetPanel.editModeType.DISABLED);
            view.resultsetPanel.deselectAll();
        } else {
