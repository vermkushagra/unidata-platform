...
Ext.define('Unidata.view.steward.dataentity.layout.MultiColumnLayout', {
    ...
    initComponent: function () {
        ...
        Ext.Array.each(this.tablets, function (tablet) {
            ...
            // Скрывать группы атрибутов, если в них отсутствуют атрибуты
            // Только для панели простых атрибутов
            if (!isAdmin && tablet instanceof Unidata.view.steward.dataentity.simple.AttributeTablet) {
