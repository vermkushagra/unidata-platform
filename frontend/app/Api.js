Ext.define('Unidata.Api', {
    ...
    statics: {
        ...
        getMetaDependencyGraphUrl: function (draft) {
            var url;

            url = this.createUrl('/meta/model/dependency' + '?' + 'draft=' + Boolean(draft));
        ...
        getAtomicUpsertUrl: function (etalonId) {
            var url;

            url = '/data/entities/atomic';
        ...
        getCleanseFunctionsUrl: function () {
            return this.createUrl('/meta/cleanse-functions');
        },

        getCleanseFunctionExecuteUrl: function () {
            return this.createUrl('/meta/cleanse-functions/execute');
        },

        getSourceSystemsUrl: function () {
            return this.createUrl('/meta/source-systems');
        }
    }
});
