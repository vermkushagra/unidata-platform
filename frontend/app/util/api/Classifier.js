...
Ext.define('Unidata.util.api.Classifier', {
    ...
    getClassifierTreeView: function (url, params) {
        ...
        function onAjaxRequestSuccess (response) {
            ...
            function applyRootNodeWrapperJson (rootCfg) {
                ...
                //    name: '',
                //    expanded: true,
                //    children: rootCfg.children,
                //    childCount: rootCfg.childCount ? rootCfg.childCount : 1,
                //    leaf: false,
                //    rootCfg: true,
                //    classifierName: rootCfg.classifierName
                //};
            }
    ...
    buildClassifierNodeAttrs: function (classifierName, classifierNode) {
        ...
        nodeAttrs = Ext.Array.merge(ownNodeAttrs.getRange(), inheritedNodeAttrs.getRange());
