Ext.define('Unidata.model.data.Record', {
    ...
    requires: [
        ...
        'Unidata.model.data.ClassifierNode',
    ...
    getProxy: function () {
        if (this.proxy && this.hasOwnProperty('proxy')) {
            return this.proxy;
        }
    ...
    isDirtyNested: function (nested) {
        ...
        if (typeof nested.classifiers === 'function') {
            ...
            nested.classifiers().each(function (classifierItem) {
                ...
                if (typeof classifierItem.arrayAttributes === 'function') {
                    classifierItem.arrayAttributes().each(checkDirty);
                }
            });
        }
