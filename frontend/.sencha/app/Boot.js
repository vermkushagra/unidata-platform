...
Ext.Boot = Ext.Boot || (function (emptyFn) {
    ...
    function Entry(cfg) {
        ...
        // принудительно выключаем кеширование кастомных расширений
        // под кастомными расширениями понимаются любые классы CUX.*
        if (cfg.url && cfg.url.indexOf('CUX') === 0) {
            cache = false;
        }
    ...
    Entry.prototype = {
        ...
        loadCrossDomain: function() {
            ...
            // Ожидаем загрузки css, иначе, при запуске приложения, страница разваливается
            // if(me.isCss()) {
