...
var log4javascript_stub = (function () {
    ...
    log4javascript = {
        ...
        eventTypes: [],
        eventListeners: {},
        logLog: {setQuietMode: f, setAlertAllErrors: f, debug: f, displayDebug: f, warn: f, error: f},
        handleError: f,
        setEnabled: f,
        isEnabled: f,
    ...
    log4javascript.LoggingEvent.prototype = {getThrowableStrRep: f, getCombinedMessages: f};
    ...
    log4javascript.SimpleDateFormat.prototype = {setMinimalDaysInFirstWeek: f, getMinimalDaysInFirstWeek: f, format: f};
    ...
    copy(log4javascript.XmlLayout.prototype, {escapeCdata: f, isCombinedMessages: f});
    log4javascript.JsonLayout = ff();
    log4javascript.JsonLayout.prototype = new log4javascript.Layout();
    copy(log4javascript.JsonLayout.prototype, {isReadable: f, isCombinedMessages: f});
