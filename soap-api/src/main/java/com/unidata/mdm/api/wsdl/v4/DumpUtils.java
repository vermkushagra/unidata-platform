...
import com.unidata.mdm.api.v4.AliasCodeAttributePointerDef;
...
import com.unidata.mdm.data.v4.ApprovalState;
import com.unidata.mdm.data.v4.ArrayAttribute;
import com.unidata.mdm.data.v4.ArrayDataType;
import com.unidata.mdm.data.v4.BlobValue;
import com.unidata.mdm.data.v4.ClobValue;
import com.unidata.mdm.data.v4.CodeAttribute;
import com.unidata.mdm.data.v4.ComplexAttribute;
import com.unidata.mdm.data.v4.DataQualityStatusType;
import com.unidata.mdm.data.v4.EtalonClassifierRecord;
import com.unidata.mdm.data.v4.EtalonRecord;
import com.unidata.mdm.data.v4.EtalonRecordInfoSection;
import com.unidata.mdm.data.v4.IntegralRecord;
import com.unidata.mdm.data.v4.MeasuredValue;
...
import com.unidata.mdm.data.v4.OriginRecordInfoSection;
import com.unidata.mdm.data.v4.RecordStatus;
import com.unidata.mdm.data.v4.RelationBase;
import com.unidata.mdm.data.v4.RelationTo;
import com.unidata.mdm.data.v4.RelationToInfoSection;
...
public class DumpUtils {
     ...
     */
    public static EtalonKey from(com.unidata.mdm.data.v4.EtalonKey soapKey) {
     ...
     */
    public static OriginKey from(com.unidata.mdm.data.v4.OriginKey soapKey) {
     ...
     */
    public static ReferenceAliasKey from(com.unidata.mdm.api.v4.ReferenceAliasKey soapKey) {
        if (Objects.isNull(soapKey)) {
            return null;
        }
     ...
     */
    public static com.unidata.mdm.data.v4.EtalonKey to(EtalonKey systemKey) {
     ...
     */
    public static com.unidata.mdm.data.v4.OriginKey to(OriginKey systemKey) {
        if (Objects.isNull(systemKey)) {
            return null;
        }
     ...
     */
    public static com.unidata.mdm.data.v4.DataQualityError to(DataQualityError error) {

        if (Objects.isNull(error)) {
            return null;
        }

        return new com.unidata.mdm.data.v4.DataQualityError()
     ...
     * @return the list
     */
    public static List<com.unidata.mdm.data.v4.DataQualityError> to(List<DataQualityError> error) {

        if (CollectionUtils.isEmpty(error)) {
            return Collections.emptyList();
        }

        List<com.unidata.mdm.data.v4.DataQualityError> result = new ArrayList<>();
