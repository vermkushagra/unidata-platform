...
import com.unidata.mdm.api.v3.AsyncSectionDef;
import com.unidata.mdm.api.v3.ClassifierPointerDef;
import com.unidata.mdm.api.v3.ClassifierPointerType;
import com.unidata.mdm.api.v3.CommonResponseDef;
import com.unidata.mdm.api.v3.CommonSectionDef;
import com.unidata.mdm.api.v3.CredentialsDef;
import com.unidata.mdm.api.v3.DeleteRelationDef;
import com.unidata.mdm.api.v3.DeleteRelationRecordDef;
import com.unidata.mdm.api.v3.ExecutionErrorDef;
import com.unidata.mdm.api.v3.ExecutionMessageDef;
import com.unidata.mdm.api.v3.ExitCodeType;
import com.unidata.mdm.api.v3.ReferenceAliasKey;
import com.unidata.mdm.api.v3.RequestBulkUpsert;
import com.unidata.mdm.api.v3.RequestCleanse;
import com.unidata.mdm.api.v3.RequestGet;
import com.unidata.mdm.api.v3.RequestGetDataQualityErrors;
import com.unidata.mdm.api.v3.RequestGetLookupValues;
import com.unidata.mdm.api.v3.RequestInfoGet;
import com.unidata.mdm.api.v3.RequestMerge;
import com.unidata.mdm.api.v3.RequestRelationsGet;
import com.unidata.mdm.api.v3.RequestRelationsSoftDelete;
import com.unidata.mdm.api.v3.RequestRelationsUpsert;
import com.unidata.mdm.api.v3.RequestSearch;
import com.unidata.mdm.api.v3.RequestSoftDelete;
import com.unidata.mdm.api.v3.RequestUpsert;
import com.unidata.mdm.api.v3.ResponseAuthenticate;
import com.unidata.mdm.api.v3.ResponseBulkUpsert;
import com.unidata.mdm.api.v3.ResponseGet;
import com.unidata.mdm.api.v3.ResponseInfoGet;
import com.unidata.mdm.api.v3.ResponseJoin;
import com.unidata.mdm.api.v3.ResponseMerge;
import com.unidata.mdm.api.v3.ResponseRelationsGet;
import com.unidata.mdm.api.v3.ResponseRelationsSoftDelete;
import com.unidata.mdm.api.v3.ResponseRelationsUpsert;
import com.unidata.mdm.api.v3.ResponseSearch;
import com.unidata.mdm.api.v3.ResponseSoftDelete;
import com.unidata.mdm.api.v3.ResponseUpsert;
import com.unidata.mdm.api.v3.RoleRefDef;
import com.unidata.mdm.api.v3.SecuritySectionDef;
import com.unidata.mdm.api.v3.SessionTokenDef;
import com.unidata.mdm.api.v3.SoftDeleteActionType;
import com.unidata.mdm.api.v3.Statistic;
import com.unidata.mdm.api.v3.StatisticEnum;
import com.unidata.mdm.api.v3.TimeSerie;
import com.unidata.mdm.api.v3.UnidataRequestBody;
import com.unidata.mdm.api.v3.UnidataResponseBody;
...
import com.unidata.mdm.data.v3.ComplexAttribute;
import com.unidata.mdm.data.v3.DataQualityError;
import com.unidata.mdm.data.v3.EntityRelations;
import com.unidata.mdm.data.v3.EtalonClassifierRecord;
import com.unidata.mdm.data.v3.EtalonKey;
import com.unidata.mdm.data.v3.EtalonRecord;
import com.unidata.mdm.data.v3.IntegralRecord;
import com.unidata.mdm.data.v3.NestedRecord;
...
import com.unidata.mdm.data.v3.RelationBase;
...
public class SoapApiServiceImpl extends UnidataServicePortImpl {
    ...
    /**
     * Version 44 transformer.
     */
    @Autowired
    private DataVersion44Transformer soapVersion44Transformer;
    /**
     * WS context.
     */
    @Resource
    ...
    private void handleRequestGet(UnidataRequestBody request, UnidataResponseBody response) {
        ...
        try {
            ...
            EtalonRecord etalon =  DumpUtils.to(result.getEtalon(),
                    result.getEtalon() != null ? result.getEtalon().getInfoSection() : null,
                            EtalonRecord.class);

            if (etalon != null) {

                EntityRelations relations = JaxbUtils.getDataObjectFactory().createEntityRelations();
                for (Iterator<Entry<RelationStateDTO, List<GetRelationDTO>>> it = MapUtils.isEmpty(result.getRelations())
                        ? null
                        : result.getRelations().entrySet().iterator(); it != null && it.hasNext(); ) {
                ...
                etalon.withRelations(relations)
                      .withClassifiers(MapUtils.isEmpty(result.getClassifiers())
                          ? Collections.emptyList()
                          : result.getClassifiers().values().stream()
                              .flatMap(Collection::stream)
                              .filter(cls -> Objects.nonNull(cls) && Objects.nonNull(cls.getEtalon()))
                              .map(cls -> DumpUtils.to(cls.getEtalon(), cls.getEtalon().getInfoSection(), EtalonClassifierRecord.class))
                      .collect(Collectors.toList()));
            }
...
//                    .countOnly(request.getRequestSearch().isDoCountOnly())
    ...
    private UpsertRequestContext convertToUpsertContext(RequestUpsert requestUpsert, CommonSectionDef commonSection, boolean bulkUpsert) {
        ...
        DataRecord record = DumpUtils.from(requestUpsert.getEtalonRecord() == null
                ? requestUpsert.getOriginRecord()
                : requestUpsert.getEtalonRecord());

        if (Objects.nonNull(record)) {
            soapVersion44Transformer.apply(record, entityName);
        }
	...
	private void enrichSimple(SimpleAttribute attr, String entityName, String path) {
		...
		if (attr.getType() == null) {
			AbstractSimpleAttributeDef attributeDef = (AbstractSimpleAttributeDef) metaModelService.getAttributeByPath(
    ...
    private boolean doLogin(UnidataRequestBody request) {
        return request.getRequestAuthenticate() == null ? false : request.getRequestAuthenticate().isDoLogin();
    }
    ...
    private List<ClassifierIdentityContext> convertToClassifiers(
        ...
        for (EtalonClassifierRecord ecr : etalonClassifiers) {
            ...
            if (ecr.getStatus() == com.unidata.mdm.data.v3.RecordStatus.INACTIVE) {
        ...
        for (OriginClassifierRecord ocr : originClassifiers) {
            ...
            if (ocr.getStatus() ==  com.unidata.mdm.data.v3.RecordStatus.INACTIVE) {
