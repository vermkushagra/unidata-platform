 ...
 *       &lt;sequence&gt;
 *         &lt;element name="common" type="{http://api.mdm.unidata.com/v4/}CommonResponseDef"/&gt;
 *         &lt;choice minOccurs="0"&gt;
 *           &lt;element name="responseAuthenticate" type="{http://api.mdm.unidata.com/v4/}ResponseAuthenticate"/&gt;
 *           &lt;element name="responseGetLookupValues" type="{http://api.mdm.unidata.com/v4/}ResponseGetLookupValues"/&gt;
 *           &lt;element name="responseCleanse" type="{http://api.mdm.unidata.com/v4/}ResponseCleanse"/&gt;
 *           &lt;element name="responseUpsert" type="{http://api.mdm.unidata.com/v4/}ResponseUpsert"/&gt;
 *           &lt;element name="responseRelationsUpsert" type="{http://api.mdm.unidata.com/v4/}ResponseRelationsUpsert"/&gt;
 *           &lt;element name="responseMerge" type="{http://api.mdm.unidata.com/v4/}ResponseMerge"/&gt;
 *           &lt;element name="responseJoin" type="{http://api.mdm.unidata.com/v4/}ResponseJoin"/&gt;
 *           &lt;element name="responseSoftDelete" type="{http://api.mdm.unidata.com/v4/}ResponseSoftDelete"/&gt;
 *           &lt;element name="responseRelationsSoftDelete" type="{http://api.mdm.unidata.com/v4/}ResponseRelationsSoftDelete"/&gt;
 *           &lt;element name="responseGet" type="{http://api.mdm.unidata.com/v4/}ResponseGet"/&gt;
 *           &lt;element name="responseGetAllPeriods" type="{http://api.mdm.unidata.com/v4/}ResponseGetAllPeriods"/&gt;
 *           &lt;element name="responseRelationsGet" type="{http://api.mdm.unidata.com/v4/}ResponseRelationsGet"/&gt;
 *           &lt;element name="responseSearch" type="{http://api.mdm.unidata.com/v4/}ResponseSearch"/&gt;
 *           &lt;element name="responseGetDataQualityErrors" type="{http://api.mdm.unidata.com/v4/}ResponseGetDataQualityErrors"/&gt;
 *           &lt;element name="responseInfoGet" type="{http://api.mdm.unidata.com/v4/}ResponseInfoGet"/&gt;
 *           &lt;element name="responseBulkUpsert" type="{http://api.mdm.unidata.com/v4/}ResponseBulkUpsert"/&gt;
 *           &lt;element name="responseFindAllJobs" type="{http://api.mdm.unidata.com/v4/}ResponseFindAllJobs"/&gt;
 *           &lt;element name="responseSaveJob" type="{http://api.mdm.unidata.com/v4/}ResponseSaveJob"/&gt;
 *           &lt;element name="responseRemoveJob" type="{http://api.mdm.unidata.com/v4/}ResponseRemoveJob"/&gt;
 *           &lt;element name="responseFindJob" type="{http://api.mdm.unidata.com/v4/}ResponseFindJob"/&gt;
 *           &lt;element name="responseRunJob" type="{http://api.mdm.unidata.com/v4/}ResponseRunJob"/&gt;
 *           &lt;element name="responseJobStatus" type="{http://api.mdm.unidata.com/v4/}ResponseJobStatus"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
