 ...
 * generated in the com.unidata.mdm.api.v4 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ApiRequestBody_QNAME = new QName("http://api.mdm.unidata.com/v4/", "apiRequestBody");
    private final static QName _ApiResponseBody_QNAME = new QName("http://api.mdm.unidata.com/v4/", "apiResponseBody");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.unidata.mdm.api.v4
     * 
     */
    ...
    /**
     * Create an instance of {@link SortConditionDef }
     * 
     */
    public SortConditionDef createSortConditionDef() {
        return new SortConditionDef();
    }
    ...
    /**
     * Create an instance of {@link JobExecutionStep }
     * 
     */
    public JobExecutionStep createJobExecutionStep() {
        return new JobExecutionStep();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://api.mdm.unidata.com/v4/", name = "apiRequestBody")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://api.mdm.unidata.com/v4/", name = "apiResponseBody")
