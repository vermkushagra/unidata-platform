 ...
 *       &lt;sequence&gt;
 *         &lt;choice&gt;
 *           &lt;element name="originKeys" type="{http://data.mdm.unidata.com/v4/}OriginKey" maxOccurs="unbounded"/&gt;
 *           &lt;element name="etalonKeys" type="{http://data.mdm.unidata.com/v4/}EtalonKey" maxOccurs="unbounded"/&gt;
 *         &lt;/choice&gt;
 *         &lt;element name="originActions" type="{http://api.mdm.unidata.com/v4/}UpsertActionType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
