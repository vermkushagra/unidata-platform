 ...
 *       &lt;sequence&gt;
 *         &lt;element name="searchCondition" type="{http://api.mdm.unidata.com/v4/}SearchConditionDef"/&gt;
 *         &lt;element name="sortCondition" type="{http://api.mdm.unidata.com/v4/}SortConditionDef" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
    ...
    implements Serializable
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-06-05T12:30:07+03:00", comments = "JAXB RI v2.2.11")
    protected List<SortConditionDef> sortCondition;
     ...
     * {@link SortConditionDef }
     * 
     * 
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-06-05T12:30:07+03:00", comments = "JAXB RI v2.2.11")
    public List<SortConditionDef> getSortCondition() {
        if (sortCondition == null) {
            sortCondition = new ArrayList<SortConditionDef>();
        }
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-06-05T12:30:07+03:00", comments = "JAXB RI v2.2.11")
    public RequestSearch withSortCondition(SortConditionDef... values) {
        if (values!= null) {
            for (SortConditionDef value: values) {
                getSortCondition().add(value);
            }
        }
        return this;
    }
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-06-05T12:30:07+03:00", comments = "JAXB RI v2.2.11")
    public RequestSearch withSortCondition(Collection<SortConditionDef> values) {
        if (values!= null) {
            getSortCondition().addAll(values);
        }
        return this;
    }
