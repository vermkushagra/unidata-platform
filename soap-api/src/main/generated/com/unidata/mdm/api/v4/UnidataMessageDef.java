 ...
 *       &lt;choice&gt;
 *         &lt;element name="upsertEventDetails" type="{http://api.mdm.unidata.com/v4/}UpsertEventDetailsDef"/&gt;
 *         &lt;element name="upsertEventClassifierDetails" type="{http://api.mdm.unidata.com/v4/}UpsertEventClassifierDetailsDef"/&gt;
 *         &lt;element name="UpsertEventRelationDetailsDef" type="{http://api.mdm.unidata.com/v4/}UpsertEventRelationDetailsDef"/&gt;
 *         &lt;element name="mergeEventDetails" type="{http://api.mdm.unidata.com/v4/}MergeEventDetailsDef"/&gt;
 *         &lt;element name="softDeleteEventDetails" type="{http://api.mdm.unidata.com/v4/}SoftDeleteEventDetailsDef"/&gt;
 *         &lt;element name="softDeleteClassifierEventDetails" type="{http://api.mdm.unidata.com/v4/}SoftDeleteClassifierEventDetailsDef"/&gt;
 *         &lt;element name="softDeleteRelationEventDetails" type="{http://api.mdm.unidata.com/v4/}SoftDeleteRelationEventDetailsDef"/&gt;
 *         &lt;element name="restoreEventDetails" type="{http://api.mdm.unidata.com/v4/}RestoreEventDetailsDef"/&gt;
 *         &lt;element name="wipeDeleteEventDetails" type="{http://api.mdm.unidata.com/v4/}WipeDeleteEventDetailsDef"/&gt;
 *       &lt;/choice&gt;
 *       &lt;attribute name="eventType" use="required" type="{http://api.mdm.unidata.com/v4/}UnidataEventType" /&gt;
