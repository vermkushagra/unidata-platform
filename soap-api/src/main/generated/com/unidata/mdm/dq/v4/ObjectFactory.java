 ...
 * generated in the com.unidata.mdm.dq.v4 package. 
...
public class ObjectFactory {
    ...
    private final static QName _SecurityHeader_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "securityHeader");
    private final static QName _InfoHeader_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "infoHeader");
    private final static QName _LoginRequest_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "loginRequest");
    private final static QName _LoginResponse_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "loginResponse");
    private final static QName _LogoutRequest_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "logoutRequest");
    private final static QName _LogoutResponse_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "logoutResponse");
    private final static QName _ApplyDQRequestWrapper_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "applyDQRequestWrapper");
    private final static QName _GetResultsRequest_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "getResultsRequest");
    private final static QName _GetResultsResponse_QNAME = new QName("http://dq.mdm.unidata.com/v4/", "getResultsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.unidata.mdm.dq.v4
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "securityHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "infoHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "loginRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "loginResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "logoutRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "logoutResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "applyDQRequestWrapper")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "getResultsRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dq.mdm.unidata.com/v4/", name = "getResultsResponse")
