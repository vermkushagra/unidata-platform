 ...
 *           &lt;element name="applicable" type="{http://dq.mdm.unidata.com/v5/}DQRuleType" maxOccurs="unbounded"/&gt;
 *           &lt;element name="tags" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/choice&gt;
 *       &lt;attribute name="mode" use="required" type="{http://dq.mdm.unidata.com/v5/}DQApplyModeType" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
    ...
    implements Serializable
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-06-05T12:30:15+03:00", comments = "JAXB RI v2.2.11")
    public DQApplyInfoType withTags(String... values) {
        if (values!= null) {
            for (String value: values) {
                getTags().add(value);
            }
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-06-05T12:30:15+03:00", comments = "JAXB RI v2.2.11")
    public DQApplyInfoType withTags(Collection<String> values) {
        if (values!= null) {
