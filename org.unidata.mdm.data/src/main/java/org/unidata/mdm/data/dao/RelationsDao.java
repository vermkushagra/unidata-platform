...
public interface RelationsDao {
     ...
     * @param includeDrafts include draft versions into view or not
     * @return timeline
     */
    RelationTimelinePO loadTimeline(UUID etalonId, boolean fetchKeys, boolean fetchData, boolean includeDrafts);
    /**
     ...
     * @return timeline
     */
    RelationTimelinePO loadTimeline(LSN lsn, boolean fetchKeys, boolean fetchData, boolean includeDrafts);
    /**
     ...
     * @return timeline
     */
    RelationTimelinePO loadTimeline(LSN from, LSN to, String relationName, boolean fetchData, boolean includeDrafts);
    /**
     ...
     * @return timeline
     */
    RelationTimelinePO loadTimeline(ExternalId from, ExternalId to, String relationName, boolean fetchData, boolean includeDrafts);
    /**
     ...
     * @return timeline
     */
    RelationTimelinePO loadTimeline(UUID from, UUID to, String relationName, boolean fetchData, boolean includeDrafts);
    /**
     ...
     * @return timelines
     */
    List<RelationTimelinePO> loadTimelines(UUID recordEtalonId, List<String> names, boolean isToSide, boolean fetchData, boolean includeDrafts);
    /**
     ...
     * @param relationEtalonIds the etalon id
     * @param approval approval state
     * @return true, if successful, false otherwise
     */
    boolean changeEtalonApproval(List<UUID> relationEtalonIds, ApprovalState approval);
    /**
    ...
    RelationDigestDTO loadDigestDestinationEtalonIds(
            UUID recordEtalonId, String relationName, RelationSide viewSide, Map<String, Integer> sourceSystems, Date date, int count, int from);
    /**
     ...
     * @return
     */
    boolean updateApprovalState(UUID relationEtalonId, ApprovalState to);
    /**
     ...
     */
    List<RelationKeysPO> loadAllKeysByRecordEtalonId(UUID recordEtalonId, RelationSide side);
    /**
