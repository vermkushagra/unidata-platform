...
public final class RecordFactoryUtils {
     ...
     */
    public static RecordOriginPO createOriginRecordPO(@Nonnull UpsertRequestContext ctx, @Nonnull RecordKeys keys, RecordStatus status) {
     ...
     * @return new etalon record
     */
    public static RecordOriginPO createOriginRecordPO(DeleteRequestContext ctx, RecordKeys keys, RecordStatus status) {
     ...
     * @return new etalon record
     */
    public static RecordEtalonPO createEtalonRecordPO(UpsertRequestContext ctx, RecordKeys keys, RecordStatus status) {
     ...
     * @return new etalon record
     */
    public static RecordEtalonPO createEtalonRecordPO(DeleteRequestContext ctx, RecordKeys keys, RecordStatus status) {
     ...
     */
    public static RecordOriginPO createSystemOriginRecordPO(UpsertRequestContext ctx, String etalonId) {
    ...
    /**
         ...
         * @return new object
         */
        public static RecordVistoryPO createVistoryRecordPO(
