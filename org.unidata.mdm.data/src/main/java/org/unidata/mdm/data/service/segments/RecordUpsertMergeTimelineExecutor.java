 ...
 */
@Component(RecordUpsertMergeTimelineExecutor.SEGMENT_ID)
public class RecordUpsertMergeTimelineExecutor extends Point<UpsertRequestContext> {
    /**
     * This segment ID.
     */
    public static final String SEGMENT_ID = DataModule.MODULE_ID + "[RECORD_UPSERT_MERGE_TIMELINE]";
    /**
     * Localized message code.
     */
    public static final String SEGMENT_DESCRIPTION = DataModule.MODULE_ID + ".record.upsert.merge.timeline.description";
    /**
     * The MMS.
     */
    @Autowired
     ...
     * @param description
     */
    public RecordUpsertMergeTimelineExecutor() {
