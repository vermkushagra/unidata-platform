 ...
 */
public abstract class CommonRequestContext implements Serializable, BooleanFlagsContext, StorageCapableContext {
    /**
     * Default SVUID.
     */
    ...
    /**
     * @see org.unidata.mdm.core.type.context.ExecutionContext#putToUserContext(String, Object)
     */
    public <T> void putToUserStorage(String name, T t) {
        userStorage.put(name, t);
    }
    /**
     * @see org.unidata.mdm.core.type.context.ExecutionContext#getFromUserContext(String)
     */
    @SuppressWarnings("unchecked")
     ...
     * @param <X>
     */
    public abstract static class CommonRequestContextBuilder<X extends CommonRequestContextBuilder<X>> {
        /**
         * Operation id, special attribute for grouping, tracing, etc. actions.
         */
