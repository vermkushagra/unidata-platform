...
public class ConvertUtils {
    ...
    private static final DateTimeFormatter DEFAULT_DATE_FORMATTER_NO_OFFSET
            = DateTimeFormatter.ofPattern("yyyy-MM-dd");

    private static final DateTimeFormatter DEFAULT_DATE_TIME_FORMATTER_NO_OFFSET
     ...
     * Zero offset TF.
     */
    public static final DateTimeFormatter ZULU_DATE_TIME_FORMATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
    ...
    public static Date localDate2DateUsingParser(LocalDate d) {
        try {
            return d == null ? null : DATE_FORMAT.parse(d.format(DEFAULT_DATE_FORMATTER_NO_OFFSET));
    ...
    public static Date localDateTime2DateUsingParser(LocalDateTime d) {
        try {
            return d == null ? null : DATE_TIME_FORMAT.parse(d.format(DEFAULT_DATE_TIME_FORMATTER_NO_OFFSET));
        } catch (ParseException e) {
            // TODO : UN-11834
            return null;
            /*
    ...
    public static String localDateTime2UTCAndFormat(LocalDateTime ldt) {
        return ldt == null ? null : ZULU_DATE_TIME_FORMATTER.format(localDateTime2OffsetDateTime(ldt, ConvertUtils.UTC_ZONE_ID));
    }
}
