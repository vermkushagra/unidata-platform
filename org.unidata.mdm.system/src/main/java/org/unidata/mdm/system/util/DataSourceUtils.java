...
public final class DataSourceUtils {
	...
	public static DataSource newPoolingNonXADataSource(Properties properties) {
		...
		try {
			...
			throw new PlatformFailureException(message, SystemExceptionIds.EX_SYSTEM_CANNOT_CREATE_NON_XA_DATASOURCE, e);
		}
	}
	/**
	 * Creates a data source.
	...
	public static DataSource newPoolingXADataSource(Properties properties) {
    	...
    	try {
			...
			throw new PlatformFailureException(message, SystemExceptionIds.EX_SYSTEM_CANNOT_CREATE_XA_DATASOURCE, e);
		}
