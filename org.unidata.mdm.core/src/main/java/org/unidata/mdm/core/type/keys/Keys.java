...
public abstract class Keys<E extends EtalonKey, O extends OriginKey> {
    ...
    /**
     * Whether this record was published (i. e. has at least one {@link ApprovalState#APPROVED} version).
     */
     ...
     * @return type
     */
    public abstract KeysType getType();
    /**
    ...
    /**
     * Tells, whether this key is inactive. A node without a valid etalon key will answer false.
     * @return true, if inactive, false otherwise
     */
    public boolean isPending() {
        return etalonKey != null && etalonKey.isPending();
    }
    /**
