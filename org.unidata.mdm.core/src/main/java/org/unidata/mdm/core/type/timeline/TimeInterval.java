...
import org.unidata.mdm.core.type.data.ValidityRange;
...
public interface TimeInterval<T extends Calculable> extends Iterable<CalculableHolder<T>>, ValidityRange {
    ...
    boolean isPending();
    /**
     * Sets this interval pendiing.
     * @param pending the pending mark
     */
    ...
    default long getPeriodId() {
        return Objects.isNull(getValidTo()) ? PeriodIdUtils.TIMELINE_POSITIVE_INFINITY : getValidTo().getTime();
    }
