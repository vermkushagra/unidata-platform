package org.unidata.mdm.core.exception;
...
public class CoreExceptionIds {
     ...
     */
    public static final ExceptionId EX_UPATH_INVALID_INPUT_ENTITY_OR_PATH_BLANK
            = new ExceptionId("EX_UPATH_INVALID_INPUT_ENTITY_OR_PATH_BLANK", "app.upath.invalid.input.entity.or.path.blank");
    /**
     * Invalid state. Entity not found by name.
     */
    public static final ExceptionId EX_UPATH_ENTITY_NOT_FOUND_BY_NAME
            = new ExceptionId("EX_UPATH_ENTITY_NOT_FOUND_BY_NAME", "app.upath.invalid.state.entity.not.found.by.name");
    /**
     ...
     */
    public static final ExceptionId EX_SYSTEM_INDEX_LOCK_TIME_OUT
            = new ExceptionId("EX_SYSTEM_INDEX_LOCK_TIME_OUT", "app.error.while.creating.indexes.lock.time.out");
    /**
     *
     */
