...
public class ReverseNestedAggregationRequestContext extends AbstractAggregationRequestContext {
    ...
    public static class ReverseNestedAggregationRequestContextBuilder {
         ...
         * @return self
         */
        public ReverseNestedAggregationRequestContextBuilder subAggregation(AggregationSearchContext agg) {
         ...
         * @return self
         */
        public ReverseNestedAggregationRequestContextBuilder subAggregations(Collection<AggregationSearchContext> aggs) {
