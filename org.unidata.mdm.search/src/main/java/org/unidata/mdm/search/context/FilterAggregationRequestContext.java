...
public class FilterAggregationRequestContext extends AbstractAggregationRequestContext {
    ...
    public static class FilterAggregationRequestContextBuilder {
         ...
         * @return self
         */
        public FilterAggregationRequestContextBuilder subAggregation(AggregationSearchContext agg) {
         ...
         * @return self
         */
        public FilterAggregationRequestContextBuilder subAggregations(Collection<AggregationSearchContext> aggs) {
